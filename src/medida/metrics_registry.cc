...
namespace medida {
    ...
    Timer& MetricsRegistry::NewTimer(const MetricName &name, std::chrono::nanoseconds duration_unit, std::chrono::nanoseconds rate_unit) {
...
// === Implementation ===
    ...
    Histogram& MetricsRegistry::Impl::NewHistogram(const MetricName &name, SamplingInterface::SampleType sample_type) {
